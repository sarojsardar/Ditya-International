...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front/css/vendor/brands.css') }}">
    <link rel="stylesheet" href="{{ asset('front/css/vendor/regular.css') }}">
    <link rel="stylesheet" href="{{ asset('front/css/vendor/solid.css') }}">
    <link rel="stylesheet" href="{{ asset('front/css/vendor/swiper-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front/css/style.css') }}">
    <title>Ditya International Private Limited: Home</title>
</head>
...
<script src="{{ asset('front/js/swiper-script.js') }}"></script>
<script src="{{ asset('front/js/submit-form.js') }}"></script>
            ...
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <div class="logo-container">
                        @if (@$setting->site_logo)
                            <a href="/"><img src="{{ url('/storage/public/uploads/site-logo/' . @$setting->site_logo) }}"
                                    alt="logo" height="70px" class="img-fluid1" title="Logo"></a>
                          @else
                            <a href="/"><img src="{{ asset('assets/images/logo.png') }}" alt="logo"
                                             title="Logo" height="70px" class="img-fluid1"></a>
                        @endif
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 font-2 fw-semibold gap-lg-3">
                        <li class="nav-item">
                            <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteName() == 'web.home' ? 'active' : '' }}" aria-current="page" href="{{ route('web.home') }}">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @foreach ($services as $service)
                                    <li>
                                        <a class="dropdown-item" href="{{ route('web.singleService', $service->slug) }}">{{ $service->title }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                    ...
                    <a href="{{ route('user.login') }}" type="button" class="btn button bg-accent-color" type="submit">Login/Register</a>
                </div>
            </div>
        </nav>
    </div>
...
<main>
            ...
            <div class="row row-cols-1 row-cols-lg-2">
                <div class="col mb-3 pe-lg-3 position-relative">
                    ...
                    <div class="position-relative pe-5">
                        <img src="{{ asset('front/image/dummy-img-600x700.jpg') }}" alt="" class="img-fluid" style="z-index: -2;">
                ...
                <div class="row row-cols-1 row-cols-lg-3">
                    <div class="col">
                        <div class="card p-3 with-border-bottom border-0 shadow rounded-3">
                            <img src="{{ asset('front/image/dummy-img-600x400.jpg') }}" class="card-img-top rounded-3" alt="...">
                            <div class="card-body ">
            ...
            <div class="d-flex flex-lg-row flex-column-reverse">
                ...
                <div class="col mb-5 pe-lg-3 position-relative">
                    ...
                    <div class="position-relative ps-5">
                        <img src="{{ asset('front/image/dummy-img-600x700.jpg') }}" alt="" class="img-fluid rounded-3"
                             style="z-index: -2;">
    ...
    <section class="position-relative" style="background-image: url({{ asset('front/image/dummy-img-1920x900.jpg')}});">
        <div class="r-container">
            <div class="image-overlay"></div>
                ...
                <div class="row row-cols-1 row-cols-lg-3">
                    <div class="col mb-3">
                        <div class="card border border-light-subtle">
                            <img src="{{ asset('front/image/dummy-img-600x400.jpg') }}" class="card-img-top" alt="...">
...
<footer>
    <section class="py-5 position-relative" style="background-image: url({{ asset('front/image/dummy-img-1920x900.jpg') }});">
        <div class="r-container">
...
<script src="{{ asset('front/js/vendor/fslightbox.js') }}"></script>
<script src="{{ asset('front/js/masonry.js') }}"></script>
</body>
