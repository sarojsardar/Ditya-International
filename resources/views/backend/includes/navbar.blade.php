            ...
            <a href="{{ route('user.dashboard') }}" class="app-brand-link gap-2">
                @if (@$setting->site_logo)
                    <img src="{{ url('/storage/uploads/site-logo/' . @$setting->site_logo) }}"
                         alt="logo" height="55px"  class="logo">
                @else
                    <img src="{{ asset('assets/images/logo.png') }}" alt="logo" height="55px" class="logo">
                @endif
                <span class="app-brand-text demo menu-text fw-bold">{{ @$setting->site_name ? @$setting->site_name : config('app.name') }}</span>
            </a>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            ...
                            @else
                                <img src="{{ asset('no-profile.jpg') }}" alt="user" class="w-px-40 h-auto rounded-circle">
                            @endif
                            @else
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="text-muted">
                                            @if (auth('web')->user()->user_type == \App\Enum\UserTypes::COMPANY)
                                                {!! \Illuminate\Support\Str::limit(auth('web')->user()->companyInfo->name, 10, $end = '...') !!}
                                            @else
                                                @if(auth('web')->user()->hasRole(['CEO']))
                                                    CEO
                                                @else
                                                    {!! \Illuminate\Support\Str::limit(auth('web')->user()->userInfo->first_name, 10, $end = '...') !!}
                                                @endif
                                            @endif
                                        </small>
