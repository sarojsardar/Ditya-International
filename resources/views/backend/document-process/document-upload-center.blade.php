    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header card-header-color">
                Upload Additional Documents of <span style="font-size: 16px">{{ $candidate->first_name.' '.$candidate->middle_name.' '.$candidate->last_name }}</span>
            </div>
            <div class="card-body">
                <form action="{{ route('document-process.uploadDocument', $candidate->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="">Medical Report <span style="color: rgb(241, 69, 69)">*</span></label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="">QR File <span style="color: rgb(241, 69, 69)">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="passport_self" class="form-control select2-options" required>
                                    ...
                                    @foreach ($selves as $self)
                                        <option value="{{ $self->id }}" @if($self->id == old('passport_self')) selected @endif>{{ ucfirst($self->name) }}</option>
                                    @endforeach
                                </select>
