    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="d-flex align-items-center me-5 gap-4">
                <div class="avatar">
                    <div class="avatar-initial bg-label-primary rounded-3">
                        <i class="tf-icons ri-graduation-cap-line ri-24px"></i>
                    </div>
                </div>
                <div>
                    <h5 class="mb-0">Add new Education</h5>
        ...
        <div class="col-lg-6 mt-3">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ @$educationType->id ? route('education.types.update', @$educationType->id) : route('education.types.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (@$educationType->id)
                            @method('PUT')
                        @endif
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', @$educationType->name) }}" placeholder="" class="form-control" required>
                                    @if($errors->has('name'))
                            ...
                            <div class="col-lg-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <select name="edu_level" class="form-control select2-options">
                                        <option value="">== Choose Edu Level ==</option>
                                    ...
                                    @if($errors->has('edu_level'))
                                        <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('edu_level') }}</li></ul>
                                    @endif
                                </div>
                            </div>
