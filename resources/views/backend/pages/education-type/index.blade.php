            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="education-datatable">
                            <thead>
                                <tr>
                                    <th>S.N</th>
                                    <th>Title</th>
    ...
    <script>
        $(document).ready(function(){
            $('#education-datatable').DataTable({
                ...
                "severside": true,
                ajax: {
                    url: '{{ route('education.types.index') }}',
                    type: 'GET',
                    tryCount : 0,
                    retryLimit : 3,
        ...
        function deleteEducation(id){
            ...
            alertify.confirm("Are you sure to continue", function (ev) {
                ...
                let url = '{{ route('education.types.delete', ':id') }}'
                ...
                $.ajax({
                    ...
                    success: function(res){
                        ...
                        if(res.status == 'success'){
                            ...
                            $('#education-datatable').DataTable().ajax.reload(null, false);
                        }else{
