    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-lg-6 mt-3">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ @$languages->id ? route('language.update', @$languages->id) : route('language.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (@$language->id)
                            @method('PUT')
                        @endif
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', @$language->name) }}" placeholder="" class="form-control" required>
                                    @if($errors->has('name'))
