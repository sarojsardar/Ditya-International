    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header card-header-color">
                Candidate {{ $userDetails->userdetail->full_name }}
                Detail
            </div>
            <div class="card-body scroll-card">
                <div class="cantidate-head">
                    <a href="{{ route('candidate.printCandidateApplication', $userDetails->userdetail->user_id) }}" target="_blank"><button class="btn btn-sm btn-primary" style="margin-bottom: 15px !important;">Print/ Save Application</button></a>
                    <table width="100%">
                        <tbody>
                        <tr>
                            <td>
                                ...
                                @if(@$setting->site_logo)
                                    <img src="{{ url('/storage/uploads/site-logo/' . @$setting->site_logo) }}" alt="logo" class="logo">
                                @else
                            ...
                            <td style="padding:0;vertical-align:top;padding-right:15px;width:65%;">
                                ...
                                <table border="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $userDetails->userdetail->marital_status }}</td>
                                    </tr>
                                    <tr>
                                        <td>Spouse Name</td>
                                    ...
                                    <tr>
                                        <td>Age</td>
                                        <td>{{ $userDetails->userdetail->age }} Years</td>
                                    </tr>
                                    <tr>
                                        <td>Height</td>
                                        <td>{{ $userDetails->userdetail->height }} Ft.</td>
                                    </tr>
                                    <tr>
                                        <td>Weight</td>
                                        <td>{{ $userDetails->userdetail->weight }} KG</td>
                                    </tr>

                                    <tr>
                                        <td>Relatives in Malaysia</td>
                                        <td>{{ $userDetails->userdetail->has_relatives_in_malaysia == 1 ? 'Yes' : 'No' }}</td>
                                    </tr>

                                    <tr>
                                        <td>Accident</td>
                                        <td>{{ $userDetails->userdetail->has_been_in_accident == 1 ? 'Yes' : 'No' }}</td>
                                    </tr>
