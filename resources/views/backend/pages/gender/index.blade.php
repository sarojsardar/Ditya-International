            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" id="gender-datatable">
                            <thead>
                                <tr>
                                    <th>S.N</th>
                                    <th>Title</th>
    ...
    <script>
        ...
        function deleteGender(id){
            ...
            alertify.confirm("Are you sure to continue", function (ev) {
                ...
                let url = '{{ route('gender.delete', ':id') }}'
