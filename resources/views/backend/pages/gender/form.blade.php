    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex flex-column justify-content-center">
            <div class="d-flex align-items-center me-5 gap-4">
                ...
                <div>
                    <h5 class="mb-0">Add new Gender</h5>
                    <span>Gender Information</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mt-3">
            <div class="card m-b-30">
                <div class="card-header card-header-color">
                   <h5>Gender Details</h5>
                </div>
                <div class="card-body">
                    <form action="{{ @$genders->id ? route('gender.update', @$genders->id) : route('gender.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (@$genders->id)
                            @method('PUT')
                        @endif
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', @$genders->name) }}" placeholder="" class="form-control" required>
                                    @if($errors->has('name'))
