                                ...
                                <div class="col-lg-4 mb-4">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('first_name'))
                                            <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('first_name') }}</li></ul>
                                        @endif
                                ...
                                <div class="col-lg-4 mb-4">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('middle_name'))
                                            <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('middle_name') }}</li></ul>
                                        @endif
                                ...
                                <div class="col-lg-4 mb-4">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('last_name'))
                                            <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('last_name') }}</li></ul>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('contact'))
                                            <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('contact') }}</li></ul>
                                        @endif
                                    </div>
                                </div>
                                {{-- <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('marital_status'))
                                            <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('marital_status') }}</li></ul>
                                        @endif
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        @if($errors->has('full_address'))
                                            <ul class="parsley-errors-list filled"><li class="parsley-required">{{ $errors->first('full_address') }}</li></ul>
                                        @endif
                                    </div>
                                </div>
