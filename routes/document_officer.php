...
Route::group(['as'=>'document-officer.'], function(){
    Route::group(['prefix'=>'candidate'], function(){
        ...
        Route::get('in-visa', [DocumentAccessController::class, 'inVisaCandidate'])->name('in-visa-candidate');
        Route::post('in-visa', [DocumentAccessController::class, 'uploadFinalDocument'])->name('upload-candidate-document');
